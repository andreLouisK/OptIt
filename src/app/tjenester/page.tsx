  ...
  return (
    <>
      ...
      <ServiceBlock
        ...
        pillColor="purple"
        title="CAD/PLM-integrasjon"
        description="Vi kobler sammen CAD- og PLM-systemene dine for sømløs dataflyt i hele produktutviklingsprosessen. Du slipper manuelle overføringer og sikrer at alle jobber med oppdatert informasjon."
        bullets={[
          "Integrasjon mellom CAD og PLM",
